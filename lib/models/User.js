...
module.exports = class User {
  ...
  static async insert({ displayName, email, profileURL, image, href }) {
    const { rows } = await pool.query('INSERT INTO users (spotify_username, spotify_email, spotify_profile, spotify_image, spotify_href, token, refresh) VALUES ($1, $2, $3, $4, $5) RETURNING *', [displayName, email, profileURL, image, href]);
